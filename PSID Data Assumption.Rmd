...
Consequently, it is imperative to precisely
delineate the terminology for each generation. In our study, we
primarily categorize the subjects into three generations.
...
-  __To address these issues, my approach is to focus exclusively on
    the period when individuals are aged 0-20 and are designated as
    children within the family.__ This approach helps avoid the
